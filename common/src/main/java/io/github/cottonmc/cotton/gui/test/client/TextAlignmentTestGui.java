...
public final class TextAlignmentTestGui extends LightweightGuiDescription {
	public TextAlignmentTestGui() {
		...
		Text labelStyled = Text.literal("world")
				.styled(style -> style.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Text.of("io/github/cottonmc/cotton/gui/test"))));
		...
		Text textText = IntStream.rangeClosed(1, 3)
				.mapToObj(line -> {
					Text textStyled = Text.literal("world").styled(style -> style
							.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Text.of("io/github/cottonmc/cotton/gui/test")))
