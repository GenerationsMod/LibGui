...
import net.fabricmc.api.Environment;import net.minecraft.block.Block;
...
public class SyncedGuiDescription extends ScreenHandler implements GuiDescription {
	 ...
	 * @since 3.3.0
	 */
	public final BiConsumer<Identifier, PacketByteBuf> getPacketSender() {
		if (getNetworkSide() == NetworkSide.SERVER) {
			return (identifier, packetByteBuf) -> NetworkManager.sendToPlayer((ServerPlayerEntity) playerInventory.player, identifier, packetByteBuf);
		} else {
